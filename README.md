...
Esta librería tiene por función representar los conceptos básicos de un **SpringBoot** por medio de anotaciones, donde podemos encontrar anotaciones tales como ```@RequestMapping``` siendo implementadas.
...
como se puede apreciar en la consola, la aplicación corre por el puerto **36000** en **localhost**
